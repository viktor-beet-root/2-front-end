...
/* harmony import */ var _course__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./course */ "./src/js/course.js");
...
var Academy = /*#__PURE__*/function () {
  function Academy(options) {
    _classCallCheck(this, Academy);

    _defineProperty(this, "getCourseId", getIdfunc());

    this.errerClass = 'error';
    this.separatorList = ['.', '/', '-', ' '];
    this.courseList = [];
    this.appElem = document.getElementById(options.app);
    var pattern = this.appElem.querySelector('[data-pattern]').dataset.pattern;
    this.separator = this.separatorList.find(function (separator) {
      return pattern.indexOf(separator) !== -1;
    });
    console.log(this.separator);
    this.addCourseForm = this.appElem.querySelector(options.addCourseFormSelector);
    this.addCourseForm.addEventListener('submit', this.addCourse.bind(this));
    this.courseListElement = this.appElem.querySelector(options.courseListSelector);
    this.courseListElement.addEventListener('click', this.actionsCourse.bind(this));
    this.addsudentForm = this.appElem.querySelector(options.addStudentFormSelector);
    this.addsudentForm.addEventListener('submit', this.addStudentToCourse.bind(this));
    this.addClearErrorHandler();
  }

  _createClass(Academy, [{
    key: "addClearErrorHandler",
    value: function addClearErrorHandler() {
      var allFields = this.addCourseForm.querySelectorAll('input.required');
      var self = this;
    ...
    key: "actionsCourse",
    value: function actionsCourse(e) {
    ...
    value: function addStudentToCourse(e) {
      e.preventDefault();
      var newStudent = {
        name: this.addsudentForm[0].value
      };
      var course = this.getCourseById(e.target.dataset.courseId);
      course.addStudent(newStudent);
      course.courseElement.querySelector('.students').append(this.getHtmlStudent(newStudent));
    }
  }, {
    key: "getHtmlStudent",
    value: function getHtmlStudent(newStudent) {
      var html = "\n        <li><strong>ID:</strong> ".concat(newStudent.id, " <strong>Student Name:</strong> ").concat(newStudent.name, "</li>\n        ");
      var div = document.createElement('div');
      div.innerHTML = html;
      return div.firstElementChild;
    }
  }, {
    key: "toggleAddStudentForm",
    value: function toggleAddStudentForm() {
      this.addsudentForm.classList.toggle('active');
    }
  }, {
    key: "valideateStartDate",
    value: function valideateStartDate(data, pattern) {
      ...
      var patternArrya = this.getPatternArrya(pattern);
      this.getMapPattrenr(patternArrya);
      return new RegExp("^".concat(this.getRegExp(), "$")).test(data) && this.valideateDate(data);
    }
  }, {
    key: "valideateDate",
    value: function valideateDate(data) {
      var dateSeparate = data.split(this.separator);
      var year = dateSeparate[this.patternPList.y.index];
      var month = dateSeparate[this.patternPList.m.index];
      var day = dateSeparate[this.patternPList.d.index];
      console.log(year, month, day);
      var newDate = new Date(year, month - 1, day);
      var currentDate = new Date();
      return newDate.getTime() >= currentDate.getTime() && newDate.getDate() === +day && newDate.getMonth() + 1 === +month;
    }
  }, {
    key: "getRegExp",
    value: function getRegExp() {
      ...
      for (var key in this.patternPList) {
        tmp = regExp[this.patternPList[key].index];
        tmp = tmp + "{".concat(this.patternPList[key].count, "}");
    ...
    key: "getSeparatopString",
    value: function getSeparatopString() {
    ...
    key: "getMapPattrenr",
    value: function getMapPattrenr(patternArrya) {
      for (var key in this.patternPList) {
        for (var i = 0; i < patternArrya.length; i++) {
          var isExist = patternArrya[i].indexOf(key);
    ...
    key: "getPatternArrya",
    value: function getPatternArrya(pattern) {
    ...
    value: function addCourse(e) {
      ...
      for (var i = 0; i < this.addCourseForm.length; i++) {
      ...
      if (!this.valideateStartDate(newCourseData.start, pattern)) {
        this.errorrHandler(sartElement, 'This date is invalid');
        return;
      }

      newCourseData.id = this.getCourseId();
      var newCourse = new _course__WEBPACK_IMPORTED_MODULE_10__["default"](newCourseData);
    ...
    key: "renderHtmlCourse",
    value: function renderHtmlCourse(course) {
...
/* harmony default export */ __webpack_exports__["default"] = (Academy);
...
var Course = /*#__PURE__*/function () {
  ...
  _createClass(Course, [{
    key: "getHtmlCourse",
    value: function getHtmlCourse() {
      var html = "\n            <li class=\"course-list__item\">\n                <p><strong>Course name:</strong> ".concat(this.courseName, "</p>\n                <p><strong>Duration:</strong> ").concat(this.duration, "</p>\n                <p><strong>Start date:</strong> ").concat(this.start, "</p>\n                <ul class=\"students\"></ul>\n                <div class=\"course-list__actions\">\n                    <button data-course-id=\"").concat(this.id, "\" class=\"btn add-student-btn\">Add student</button>\n                    <button data-course-id=\"").concat(this.id, "\" class=\"btn remove-student\">Remove student</button>\n                    <button data-course-id=\"").concat(this.id, "\" class=\"btn remove-course\">Remove Course</button>\n                </div>\n            </li>\n        ");
      var div = document.createElement(div);
      div.innerHTML = html;
      return div.firstElementChild;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _academy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./academy */ "./src/js/academy.js");

var frontEnd = new _academy__WEBPACK_IMPORTED_MODULE_0__["default"]({
  app: 'app',
...
/******/ 	__webpack_require__("./src/js/academy.js");
/******/ 	__webpack_require__("./src/js/course.js");
