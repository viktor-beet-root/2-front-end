...
function myAjax(method, url, callback, data) {
  var xhr = new XMLHttpRequest(); // xhr.open('GET', 'https://jsonplaceholder.typicode.com/users');
  ...
  xhr.onprogress = function (e) {
    if (e.lengthComputable) {
      console.log("\u041E\u0442\u0440\u0438\u043C\u0430\u043D\u043E ".concat(e.loaded, "  ").concat(e.total));
    } else {
      console.log("\u041E\u0442\u0440\u0438\u043C\u0430\u043D\u043E ".concat(e.loaded));
    }
  };
}
...
/* harmony import */ var _myajax__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./myajax */ "./src/js/myajax.js");
...
(0,_myajax__WEBPACK_IMPORTED_MODULE_7__["default"])('GET', 'https://jsonplaceholder.typicode.com/users', getRes);
...
function getRes(res) {
  ...
  resData.forEach(function (item) {
    ...
    div.textContent = "ID:".concat(item.id, " Name: ").concat(item.name);
    div1.textContent = "Email: ";
    mailLink.setAttribute('href', "mailto:".concat(item.email));
    mailLink.textContent = "".concat(item.email);
    div2.textContent = "Phone: ";
    phoneLink.setAttribute('href', "tel:+".concat(item.phone));
    phoneLink.textContent = "".concat(item.phone);
    li.append(div);
