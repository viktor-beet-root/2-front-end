...
var nav = document.getElementById('menu'); //const navByTag = document.getElementsByTagName('li');
//console.log(nav);
...
var menuItems = menu.querySelectorAll('.menu__item'); // console.log(menu);
...
console.log(menuItems.forEach(function (elem) {
