...
(function () {
  ...
  var trafficLights = document.body.querySelector('.traffic-lights');
  var trafficLightsItems = trafficLights.querySelectorAll('.traffic-lights__item');
  var turnLightBtn = document.body.querySelector('.traffic-lights-action');
  ...
  var trafficLightsAuto = document.body.querySelector('.traffic-lights-auto');
  var trafficLightsAutoItems = trafficLightsAuto.querySelectorAll('.traffic-lights__item');
