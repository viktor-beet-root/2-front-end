...
var Course = /*#__PURE__*/function () {
  function Course(options) {
    ...
    _defineProperty(this, "getStudentId", getIdfunc());
  ...
  _createClass(Course, [{
    ...
    key: "getStudentById",
    value: function getStudentById(idStudent) {
      return this.studentsList.find(function (student) {
        return student.id === idStudent;
      });
    }
  }, {
    key: "changeStudentById",
    value: //1. Заменяет студента на другого (id,{student}).
    function changeStudentById(idStudent, student) {
      var indexStudent = this.getStudentIndexById(idStudent);
      if (!~indexStudent) return {};
      return this.studentsList.splice(indexStudent, 1, student);
    }
  }, {
    key: "getFullSkillList",
    value: //2. Возвращает масив всех скилов студентов skillList => fullSkillList.
    function getFullSkillList() {
      var fullSkillList = '';
      this.studentsList.map(function (student) {
        return fullSkillList = fullSkillList + student.skillList + ',';
      });
      return fullSkillList;
    }
  }, {
    key: "getUniqSkillList",
    value: //3. Возвращает масив всех скилов студентов skillList уникальный uniqSkillList.
    function getUniqSkillList() {
      return this.getFullSkillList().split(',').filter(function (skill, index, arr) {
    ...
    value: //5. Метод возвращает студента по возрасту самого старого.
    function getOldestStudent() {
      var temp = this.studentsList.slice();
      return temp.sort(function (a, b) {
        return b.age - a.age;
      })[0];
    }
  }, {
    key: "getYoungerStudent",
    value: //6. Метод молодого.
    function getYoungerStudent() {
      var temp = this.studentsList.slice();
      return temp.sort(function (a, b) {
        return a.age - b.age;
      })[0];
