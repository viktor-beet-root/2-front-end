...
var Modal = /*#__PURE__*/_createClass(function Modal(options) {
  var _this = this;
...
var Lights = /*#__PURE__*/_createClass(function Lights(options) {
  var _this = this;

  _classCallCheck(this, Lights);

  _defineProperty(this, "startLight", function () {
    _this.btnStart.disabled = true;
    _this.btnStop.disabled = false;
    var currentLight = _this.trafficLights[_this.counter++ % 3];

    _this.trafficLights.forEach(function (e) {
  ...
  _defineProperty(this, "stopLight", function () {
    ...
    _this.trafficLights.forEach(function (elem) {
      return elem.classList.remove(elem.dataset.light);
    });

    _this.btnStart.disabled = false;
    _this.btnStop.disabled = true;
  });
...
/* harmony default export */ __webpack_exports__["default"] = (Lights);
...
/******/ 	__webpack_require__("./src/js/modal-window.js");
/******/ 	__webpack_require__("./src/js/script.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/traffic-lights.js");
/******/ 	
/******/ })()
;
