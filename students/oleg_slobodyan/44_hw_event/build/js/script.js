...
var errorMessage = 'This feild is required';
var errorMessageSimbols = "Only letters";
var eventChange = new Event('change');
var lettersOnlyClass = 'letters-only';
var errorLimitLetters = 'Limit of letter is over';
var errorFullName = 'Need to write Your name and surname';
var WrongNumberFormat = 'write phone nummer like this examle +38(0xx)xxx-xx-xx';
var WrongMail = 'write email like this examle exapmle@mail.com';
var resetButton = form.querySelector('.reset-btn');
var requiredElemetslist = form.querySelectorAll('input.required,textarea.required');
var maxCountElemnt = form.querySelector('.message-counter');
var phoneElement = form.querySelector('.input-phone');
var mailElement = form.querySelector('.input-mail');
var checkBox = document.getElementById('checkbox-agree');
var isMaxError = false;
requiredElemetslist.forEach(function (elem) {
...
function checkPhoneNumber(elemt, errorMessage) {
  var regex = /^\+38\(0\d{2}\)\d{3}\-\d{2}\-\d{2}$/;
...
function submitForm(e) {
  ...
  for (var i = 0; i < this.length; i++) {
    ...
    if (this[i].classList.contains('checkbox-agree') && !this[i].checked) {
      setError(this[i], 'You need to agtree with evetything'); // this[i].nextElementSibling.style.border = '1px solid red';
