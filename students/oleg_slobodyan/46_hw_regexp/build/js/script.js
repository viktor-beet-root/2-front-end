...
(function () {
  ...
  var inputs1 = form1.querySelectorAll('input');
  var resetBtn = form1.querySelector('[type="reset"]');
  var inputPassword = form1.querySelector('[name="password"]');
  resetBtn.addEventListener('click', function () {
    inputs1.forEach(function (elem) {
  ...
  inputPassword.addEventListener('input', function () {
    var redExp = /\w+/;
    var pinckExp = /(?=.*[a-z])(?=.*[0-9])/;
    var yellowExp = /(?=.*[a-z])(?=.*[0-9])(?=.*[&%$@#])/;
    var greenExp = /(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[&%$@#])/;
