...
function message() {
  ...
  _items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.addEventListener('input', function () {
    _items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.addEventListener('blur', function () {
      ...
      if (_items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.value.length > 60) {// localStorage.setItem('text', items.textarea.value)
      } else {
        for (var i = 0; i < _items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.value.length; i++) {// if (items.textarea.value.length < 60) {
...
/* harmony import */ var _idGen__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./idGen */ "./src/js/idGen.js");
...
function postForm() {
  ...
  function commentSend(e) {
    ...
    if (_items__WEBPACK_IMPORTED_MODULE_3__["default"].userName.value !== '' && !_items__WEBPACK_IMPORTED_MODULE_3__["default"].userName.classList.contains('_error') && _items__WEBPACK_IMPORTED_MODULE_3__["default"].email.value !== '' && !_items__WEBPACK_IMPORTED_MODULE_3__["default"].email.classList.contains('_error') && !_items__WEBPACK_IMPORTED_MODULE_3__["default"].www.classList.contains('_error') && _items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.value !== '' && !_items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.classList.contains('_error')) {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].userList.push({
        userId: (0,_idGen__WEBPACK_IMPORTED_MODULE_7__["default"])(),
        username: _items__WEBPACK_IMPORTED_MODULE_3__["default"].userName.value,
        email: _items__WEBPACK_IMPORTED_MODULE_3__["default"].email.value,
        www: _items__WEBPACK_IMPORTED_MODULE_3__["default"].www.value,
        message: _items__WEBPACK_IMPORTED_MODULE_3__["default"].textarea.value,
        messageId: (0,_idGen__WEBPACK_IMPORTED_MODULE_7__["default"])()
      });

      if (localStorage.getItem('userList')) {
        _items__WEBPACK_IMPORTED_MODULE_3__["default"].userListlocal = JSON.parse(localStorage.getItem('userList'));
        _items__WEBPACK_IMPORTED_MODULE_3__["default"].userListlocal.push(_items__WEBPACK_IMPORTED_MODULE_3__["default"].userList[0]);
        localStorage.setItem('userList', JSON.stringify(_items__WEBPACK_IMPORTED_MODULE_3__["default"].userListlocal));
      } else {
    ...
    if (isValid(_items__WEBPACK_IMPORTED_MODULE_3__["default"].email_regexp, _items__WEBPACK_IMPORTED_MODULE_3__["default"].email.value)) {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].errorMsg.forEach(function (elem) {
        ...
        if (elem.dataset.type === 'email') {
          elem.textContent = _items__WEBPACK_IMPORTED_MODULE_3__["default"].msg.okEmail; // localStorage.setItem("email", items.email.value);
        }
      });
    } else {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].errorMsg.forEach(function (elem) {
    ...
    if (isValid(_items__WEBPACK_IMPORTED_MODULE_3__["default"].name_regexp, _items__WEBPACK_IMPORTED_MODULE_3__["default"].userName.value)) {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].errorMsg.forEach(function (elem) {
        ...
        if (elem.dataset.type === 'name') {
          elem.textContent = _items__WEBPACK_IMPORTED_MODULE_3__["default"].msg.okName; // localStorage.setItem("name", items.userName.value);
        }
      });
    } else {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].errorMsg.forEach(function (elem) {
  ...
  function wwwInput() {
    if (isValid(_items__WEBPACK_IMPORTED_MODULE_3__["default"].www_regexp, _items__WEBPACK_IMPORTED_MODULE_3__["default"].www.value)) {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].errorMsg.forEach(function (elem) {
        ...
        if (elem.dataset.type === 'www') {
          elem.textContent = _items__WEBPACK_IMPORTED_MODULE_3__["default"].msg.okSite; // localStorage.setItem("www", items.www.value);
        }
      });
    } else {
      _items__WEBPACK_IMPORTED_MODULE_3__["default"].errorMsg.forEach(function (elem) {
