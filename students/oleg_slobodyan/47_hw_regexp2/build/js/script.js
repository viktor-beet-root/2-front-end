...
/* harmony import */ var _course__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./course */ "./src/js/course.js");
...
var Academy = /*#__PURE__*/function () {
  ...
  _createClass(Academy, [{
    ...
    key: "clearErrorForm",
    value: function clearErrorForm() {
      for (var i = 0; i < this.addCourseForm.length; i++) {
        if (this.addCourseForm[i].tagName.toLocaleLowerCase() === 'input' && this.addCourseForm[i].closest('.form__control').classList.contains('error')) {
    ...
    value: function addCourse(e) {
      ...
      if (!this.valideateStartDate(newCourseData.start, pattern) && sartElement.value !== '') {
        this.errorrHandler(sartElement, 'This date is invalid');
        return;
      }

      newCourseData.id = this.getCourseId();
      var newCourse = new _course__WEBPACK_IMPORTED_MODULE_11__["default"](newCourseData);
    ...
    key: "validDuration",
    value: function validDuration(input) {
      var regExp = /\d+/;
