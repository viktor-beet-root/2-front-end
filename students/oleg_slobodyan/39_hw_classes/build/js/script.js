...
Course.prototype.getStudentIndexById = function (idStudent) {
  return this.studentList.map(function (student) {
    return student.id;
  }).indexOf(idStudent);
...
Course.prototype.sortStudenstBySkills = function (option) {
  ...
  var _loop = function _loop(_i) {
    if (option === true) {
      tempArr.unshift(_this.studentList.filter(function (item) {
    ...
    if (option === false) {
      tempArr.push(_this.studentList.filter(function (item) {
        if (item.skillList.length === sortArr[_i]) {
          return item;
        }
      }));
...
Course.prototype.findMostOldStud = function (param) {
  var ageList = this.studentList.map(function (item) {
    return item.age;
  });
...
Course.prototype.findRangAgeStud = function (from, to) {
  ...
  for (var _i2 = 0; _i2 < rangeArr.length; _i2++) {
    for (var j = 0; j < this.studentList.length; j++) {
      if (this.studentList[j].age.indexOf(rangeArr[_i2]) !== -1) {
