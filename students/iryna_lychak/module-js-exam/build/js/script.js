...
jQuery(function ($) {
  ...
  $(document).delegate('#modal_close, #overlay', 'click', function (e) {
    $('#modal_form').animate({
      opacity: 0,
      top: '45%'
    }, 200, function () {
  ...
  $(document).delegate('.message__smiles', 'click', function (e) {
    ...
    var text = $('form.comments__form.reply .message_textarea').val();
  ...
  $(document).delegate('button.button__reply.btn', 'click', function (e) {
    ...
    function checkDomain() {
      ...
      var regExp = /[a-zA-z]+:\/\/[^\s]*/; //console.log( inputWebsite.match(regExp));
  ...
  $('button.button__post.btn').on('click', function () {
    ...
    checkName();
    checkDomain();
    checkMessage(); //$('#user-email').on('input', validate);
    ...
    function checkName() {
      ...
      if (!username) {
        ...
        localStorage.setItem('username', username); //console.log(localStorage.getItem('username'));
      }
    }
    ...
    function checkMessage() {
      ...
      if (messageLength == 0) {
        ...
        localStorage.setItem('message', message); //console.log(localStorage.getItem('message'));
  ...
  function AddComment() {
    if (localStorage.getItem('message') && localStorage.getItem('username') && localStorage.getItem('useremail') && localStorage.getItem('userwww')) {
      ...
      var now = new Date().toLocaleTimeString(); //console.log(commentcontent);
