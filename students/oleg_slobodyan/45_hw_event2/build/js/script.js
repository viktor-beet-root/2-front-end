...
/* harmony import */ var _course__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./course */ "./src/js/course.js");
...
var Academy = /*#__PURE__*/function () {
  function Academy(options) {
    ...
    this.addCourseForm.querySelector('button[type = "reset"]').addEventListener('click', this.clearError.bind(this));
    this.addCourseForm.querySelector('[name="courseName"]').addEventListener('focus', this.removeError);
    this.addCourseForm.querySelector('[name="duration"]').addEventListener('focus', this.removeError);
    this.addCourseForm.querySelector('[name="start"]').addEventListener('focus', this.removeError);
    this.addsudentForm.querySelector('[name="fullName"]').addEventListener('focus', this.removeError);
    this.addsudentForm.querySelector('[type="reset"]').addEventListener('click', this.removeStudentForm.bind(this));
  } // 5. Закривати форму Add Student при натискані на кнопку Cansel


  _createClass(Academy, [{
    key: "removeStudentForm",
    value: function removeStudentForm() {
    ...
    value: function clearError() {
      for (var i = 0; i < this.addCourseForm.length; i++) {
        var element = this.addCourseForm[i];
    ...
    value: function addStudentToCourse(e) {
      e.preventDefault(); // Валідація імені студента на порожгє значення
    ...
    value: function addCourse(e) {
      ...
      for (var i = 0; i < this.addCourseForm.length; i++) {
        ...
        if (element.tagName.toLocaleLowerCase() === 'input' && element.value !== '') {
          newCourseData[element.getAttribute('name')] = element.value; // 1. Валідація полів на порожнє значення     
      ...
      var newCourse = new _course__WEBPACK_IMPORTED_MODULE_6__["default"](newCourseData);
    ...
    key: "checkDuration",
    value: function checkDuration(elem) {
      var regExp = /\d+/;
    ...
    key: "checktDate",
    value: function checktDate(elem) {
    ...
    key: "setErroMessage",
    value: function setErroMessage(elem, errorMessage) {
    ...
    key: "clearStudentForm",
    value: function clearStudentForm() {
