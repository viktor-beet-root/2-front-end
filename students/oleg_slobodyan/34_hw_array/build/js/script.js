...
(function () {
  ...
  buyingProduct("Bread");
  console.log(buyList);
  console.log(getBuyList(buyList)); // 3. Створення списку (не) придбаних продуктів.
  ...
  console.log(needBuyList(buyList)); // Норма
  ...
  console.log(buyList); // Максимум
  // 1. Підрахунок суми всіх продуктів (враховуючи кількість кожного) в списку.

  function totalQtyAll(arr) {
    var res = arr.reduce(function (acc, curVel) {
      return acc = acc + curVel.quantity;
    }, 0);
    return res;
  }

  console.log(totalQtyAll(buyList)); // 2. Підрахунок суми всіх (не) придбаних продуктів.

  function totalQtyNeedBuy(arr) {
    var needBuy = arr.filter(function (item) {
      return !item.isBought;
    });
    return totalQtyAll(needBuy);
  }

  console.log(totalQtyNeedBuy(buyList)); // 3. Показання продуктів в залежності від суми, (від більшого до меншого / від меншого до більшого, в залежності від параметра функції, який вона приймає)
  ...
  function sortBuyList(arr, param) {
    var sortUpList = arr.map(function (item) {
    ...
    var _loop = function _loop(i) {
      var prodItem = arr.find(function (item) {
    ...
    for (var i = 0; i < sortUpList.length; i++) {
      _loop(i);
    }
