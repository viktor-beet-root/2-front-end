...
var app = new Vue({
  ...
  methods: {
    getAge: function getAge() {
      var date = (this.currentData.getDate() + '.' + (this.currentData.getMonth() + 1) + '.' + this.currentData.getFullYear()).split('.').map(function (item) {
        return parseInt(item, 10);
      });
      var birthday = this.birthday.split('.').map(function (item) {
        return parseInt(item, 10);
      });
      var age = date[2] - birthday[2];
