...
var arrN = getRandomArray(100, 10);
console.log(arrN);
bubbleSort(arrN);
console.log(arrN);

function getRandomArray(maxNum, arrLength) {
  var randomArr = []; // let randomNum = ;
...
function printReceipt(arr) {
  arr.forEach(function (elem) {
    console.log("\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u0430 -> ".concat(elem.productName, ";\n\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E -> ").concat(elem.qty, ";\n\u0426\u0435\u043D\u0430 \u0437\u0430 \u043E\u0434\u0438\u043D \u0442\u043E\u0432\u0430\u0440 -> ").concat(elem.price, "."));
  });
...
function salePrice(arr) {
  var sum = 0;
  var temp = getPriceList(arr);
  var newArr = temp.reduce(function (sum, current) {
    return sum + current;
  }, sum);
  return newArr;
} // salePrice(receipt)
...
function highPrice(arr) {
  var temp = getPriceList(arr);
  var res = temp.reduce(function (a, b) {
    return a > b ? a : b;
  });
  return res;
...
function showAuditoryByFacility(academy, facility) {
  var temp = [];
  academy.forEach(function (e) {
    if (e.facility === facility) temp.push.apply(temp, _toConsumableArray(e.groups));
  }); // console.log(concatStr(temp));
...
function showAuditoryByGroup(academy, group) {
  academy.forEach(function (e) {
    if (group.facilityName === e.facility && group.qtyStudents <= e.qty) {
      console.log("Auditory for you group -> ".concat(e.name));
    }
  });
}
...
function removeAuditory(academy, auditory) {
  var auditoryIndex = showAuditoryList(academy).indexOf(auditory);
