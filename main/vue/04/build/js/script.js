...
/* harmony import */ var vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue/dist/vue.esm-browser */ "./node_modules/vue/dist/vue.esm-browser.js");
/* harmony import */ var _products__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./products */ "./src/js/products.js");
...
var productListData = {
  data: function data() {
    return {
      products: _products__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  methods: {
    addToCart: function addToCart(product) {
      var productIndex = cartVm.isProductInCart(product.id);
...
var productListVm = vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_5__.createApp(productListData).mount('#productList');
var cartData = {
  data: function data() {
    return {
      cartList: [],
  ...
  methods: {
    setQty: function setQty(isDecr, product) {
      if (!isDecr && product.qty === 1) return;
      product.qty = !isDecr ? product.qty - 1 : product.qty + 1;
      this.seveLocalStorage();
    },
    getTotalProcutPrice: function getTotalProcutPrice(product) {
      var price = product.price > product.specialPrice ? product.specialPrice : product.price;
      return price * product.qty;
    },
    isProductInCart: function isProductInCart(productId) {
      return this.cartList.map(function (product) {
        return product.id;
      }).indexOf(productId);
    },
    getTotal: function getTotal() {
      ...
      var piceList = this.cartList.map(function (product) {
        return _this.getTotalProcutPrice(product);
      });
      return piceList.reduce(function (previousValue, currentValue) {
    ...
    seveLocalStorage: function seveLocalStorage() {
...
var cartVm = vue_dist_vue_esm_browser__WEBPACK_IMPORTED_MODULE_5__.createApp(cartData).mount('#cart');
...
/******/ 	__webpack_require__("./src/js/products.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/scrypt.js");
/******/ 	
/******/ })()
;
